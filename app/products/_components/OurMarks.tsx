...
export default function OurMarks() {
  return (
    <div>
      <h1 className="text-3xl lg:text-7xl text-center font-semibold py-10 text-black ">
        NOS MARQUES
      </h1>
      <p className="text-sm lg:text-xl text-center leading-[1.75] text-black/80 lg:px-40 px-10 font-jakarta">
